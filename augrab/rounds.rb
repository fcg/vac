...
截止到 #{updated}，澳洲技术移民 EOI 2015-2016 年度共发出 189 邀请 #{t189} 份，489 邀请 #{t489} 份，总计 #{tall} 份。
...
parse_current("http://www.border.gov.au/Trav/Work/Skil/22-june-2016-round-results")
