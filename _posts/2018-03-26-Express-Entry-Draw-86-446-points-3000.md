...
{% for ee in site.data.ee.EE2018-03-26 %}
<tr>
<td> {{ ee.date }} </td>
<td> {{ ee.people }} </td>
<td> {{ ee.points }} </td>
...
**Ministerial Instructions respecting invitations to apply for permanent residence under the Express Entry system – March&nbsp;26, 2018**
